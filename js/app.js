...
var RootComponent = React.createClass({displayName: "RootComponent",
  ...
  render: function(){
    return (
      ...
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: "http://blog.2hr.me"}, React.createElement("i", {className: "icon-post-blogger"}), "Blog")),
      React.createElement("li", {className: "divider"}),
