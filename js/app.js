...
var RootComponent = React.createClass({displayName: "RootComponent",
  ...
  render: function(){
    return (
      ...
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: myXHRData.Blog}, React.createElement("i", {className: "icon-post-blogger"}), "Blog")),
      React.createElement("li", {className: "divider"}),
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: myXHRData.Github}, React.createElement("i", {className: "icon-drive-code"}), "Github")),
      React.createElement("li", {className: "divider"}),
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: myXHRData.Facebook}, React.createElement("i", {className: "icon-post-facebook"}), "Facebook")),
      React.createElement("li", {className: "divider"}),
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: myXHRData.Twitter}, React.createElement("i", {className: "icon-post-twitter"}), "Twitter")),
      React.createElement("li", {className: "divider"}),
      React.createElement("li", {className: "ripple"}, React.createElement("a", {target: "_blank", href: myXHRData.LinkedIN}, React.createElement("i", {className: "icon-post-linkedin"}), "Linked In")),
      React.createElement("li", {className: "divider"})
